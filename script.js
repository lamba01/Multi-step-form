...
// }
function submit() {
  // Assuming you have an element with an id "loading-spinner"
  var loadingSpinner = document.getElementById("loading-spinner");

  // Show loading spinner
  loadingSpinner.style.display = "inline-block";
  // Hide step4 and show step5
  step4.style.display = "none";
  step5.style.display = "flex";

  // Simulate some asynchronous operation (e.g., AJAX request)
  setTimeout(function () {
    // Hide loading spinner
    loadingSpinner.style.display = "none";
    step6.style.display = "flex";

    // You can also add any additional success message display logic here
